...
ogr2ogr -s_srs "EPSG:4326" -t_srs "EPSG:4326" -progress -overwrite -f "GeoJSON" ${project}-project.geojson PG:"dbname=tmsnap" -nln "project" -sql "SELECT id AS id,ST_AsText(geometry) FROM projects WHERE id=${project}"
